const abilities = {
    EnchantedWeapon: "Choose one weapon. It gains: Emits light (p 10), One-handed weapons may have 2D10 or 4C Mgt, Two-handed weapons gain +1 to Mgt rolls.",
    EnchantedShield: "Must be wielding a shield. The leader cannot be targeted by Ranged Attacks.",
    Extraplanar: "The leader gains the Flyer class.",
    HeroVillain: "Double the point value of this model. It can activate twice in a round, but not twice in a row. Remove movement tokens when you activate the 2nd time. Best if both leaders have this ability. Talk to your opponent when building warbands.",
    ...
    Sorcerer: "2 point spells cost 1 action to cast.",
    Tactician: "+D1 or +C1 to your warband’s Initiative rolls."
  };
